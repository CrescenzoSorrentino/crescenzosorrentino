...
export const metadata = {
  ...
  alternates: {
    canonical: "https://crescenzosorrentino.com/privacy-policy",
  },
};

const content = `<h1 class="privacy-policy-h1">Privacy Policy
...
<ol class="privacy-policy-ol">
    <li>
        <h2 class="privacy-policy-h2">Information We Collect:</h2>
        <p class="privacy-policy-p">We will collect and process the following personal information about you:</p>
        <ol class="privacy-policy-ol">
            <li>Name</li>
            <li>Email</li>
            <li>Mobile</li>
    ...
    <li>
        ...
        <p class="privacy-policy-p">We will not transfer your personal information to any third party without seeking your consent, except in limited circumstances as described below:</p>
        <ol class="privacy-policy-ol">
            <li>Analytics</li>
        </ol>
    ...
    <li>
        <h2 class="privacy-policy-h2">Retention Of Your Information:</h2>
    ...
    <li>
        ...
        <p class="privacy-policy-p">To learn more about how we use these and your choices in relation to these tracking technologies, please refer to our <a href="/cookie-policy">Cookie Policy.</a></p>
    </li>
    ...
    <li>
        <h2 class="privacy-policy-h2">Third Party Links &amp; Use Of Your Information:</h2>
...
<p class="privacy-policy-p">Privacy Policy generated with <a target="_blank" rel="noopener noreferrer" href="https://www.cookieyes.com/?utm_source=PP&utm_medium=footer&utm_campaign=UW">CookieYes</a>.</p>`;
